...
urlpatterns = [
    ...
    path('clientes/<int:pk>/emprestimos/simular/', EmprestimoViewSet.as_view({'post': 'simular_emprestimo'}), name='simular-emprestimo'),
    path('clientes/<int:pk>/emprestimos/criar/', EmprestimoViewSet.as_view({'post': 'criar_emprestimo'}), name='criar-emprestimo'),
